...
\bf The title\simon{Change title and running title}}
...
%\kwd{Keyword 1}.
%
%\href{https://mathscinet.ams.org/mathscinet/msc/msc2010.html}{MSC 2010 subject classifications}: TBD
%\end{keyword}

% history:
% \received{\smonth{12} \syear{2019}}
