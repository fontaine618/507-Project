...
The \texttt{MovieLens} datasets \citep{harper2015MovieLensDatasetsHistory} contains\dat{(contain) plural} user ratings of a variety of movies continuously collected starting from 1998. 
